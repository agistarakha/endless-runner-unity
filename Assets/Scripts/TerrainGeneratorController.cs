...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private void GenerateTerrain(float posX, TerrainTemplateController forceterrain = null)
    {
        ...
        GameObject newTerrain = GenerateFromPool((forceterrain == null) ? terrainTemplates[Random.Range(0, terrainTemplates.Count)].gameObject : forceterrain.gameObject, transform);
